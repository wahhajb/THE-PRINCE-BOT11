...
handler.help = ['*593xxx*', '*@مستخدم*', '*الرد على الدردشة*'].map((v) => 'demote ' + v);
handler.tags = ['group'];
handler.command = /^(اعفاء|quitarpoder|quitaradmin)$/i;
handler.group = true;
handler.admin = true;
